<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                <a href="{{ route("salary.index") }}" class="nav-link {{ request()->is('admin/reports') || request()->is('admin/reports/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-calendar nav-icon">
            ...
            <li class="nav-item">
                <a href="{{ route("project.index") }}" class="nav-link {{ request()->is('admin/reports') || request()->is('admin/reports/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-calendar nav-icon">
            ...
            <li class="nav-item">
                <a href="{{ route("agrement.index") }}" class="nav-link {{ request()->is('admin/reports') || request()->is('admin/reports/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-calendar nav-icon">
